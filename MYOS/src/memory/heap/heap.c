...
{
    size_t size_aligned = heap_align_value_to_upper(size);
    uint32_t total_blocks = size_aligned / MYOS_HEAP_BLOCK_SIZE;
...
void heap_mark_block_taken(struct heap* heap, uint32_t start_block, uint32_t total_blocks)
{
